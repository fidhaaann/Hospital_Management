...
export default function Analytics({ toast }) {
  ...
  return (
    <Layout pageTitle={<><i className="fas fa-chart-pie" style={{ color: 'var(--accent-primary)', marginRight: 12 }} />System Analytics &amp; Reports</>}>
      ...
      <div style={{
        ...
        <div style={{ fontSize: '0.8rem', opacity: 0.8, letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: 24, fontWeight: 700, display: 'flex', alignItems: 'center' }}>
          <i className="fas fa-wallet" style={{ marginRight: 8, fontSize: '1rem' }} /> Financial Overview Dashboard
        </div>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 24 }}>
          {[
            ...
            <div key={lbl} style={{ animation: `slideUp 0.6s cubic-bezier(0.16, 1, 0.3, 1) ${idx * 0.1}s forwards`, opacity: 0 }}>
              <div style={{ fontSize: '0.8rem', opacity: 0.8, marginBottom: 8, fontWeight: 500 }}>{lbl}</div>
              <div className="font-mono" style={{ fontSize: '2.2rem', fontWeight: 700, color: col, lineHeight: 1, letterSpacing: '-0.02em' }}>
      ...
      <div className="row row-2" style={{ marginBottom: 32 }}>
        ...
        <div className="card" style={{ animationDelay: '0.1s' }}>
          <div className="card-header">
            <><i className="fas fa-chart-area" style={{ color: 'var(--accent-primary)' }} /> Volume Metrics</>
        ...
        <div className="card" style={{ animationDelay: '0.2s', display: 'flex', flexDirection: 'column' }}>
          <div className="card-header">
            <><i className="fas fa-trophy" style={{ color: 'var(--warning)' }} /> Provider Performance</>
      ...
      <div className="row row-3" style={{ marginBottom: 32 }}>
        ...
        <div className="card" style={{ animationDelay: '0.3s' }}>
          <div className="card-header"><><i className="fas fa-users-viewfinder" style={{ color: 'var(--info)' }} /> Patient State</></div>
          <div className="card-body">
        ...
        <div className="card" style={{ animationDelay: '0.4s' }}>
          <div className="card-header">
             <><i className="fas fa-file-invoice-dollar" style={{ color: 'var(--accent-secondary)' }} /> Invoice State</>
        ...
        <div className="card" style={{ animationDelay: '0.5s' }}>
          <div className="card-header">
            <><i className="fas fa-bed-pulse" style={{ color: 'var(--danger)' }} /> Facility Load</>
